...
ee_cutflow = cutFlow(name='ee_cutflow',levels=['All','Acceptance', 'Efficiency', 
                                               'PreSelection', 'Trigger', '2e', 
...
ee_SR = cutFlow(name='ee_SR',levels=['All', 'Acceptance', 'ee SR' ])
mm_SR = cutFlow(name='mm_SR',levels=['All', 'Acceptance', 'mm SR' ])
em_SR = cutFlow(name='em_SR',levels=['All', 'Acceptance', 'em SR' ])
...
def getEfficiencies(inputFile: str) -> Dict[str, Any]:
    ...
    for entry in range(nevts):
        ...
        eff_SR.fill_next(weight*acc*recoEff)
