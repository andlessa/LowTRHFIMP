...
V_132 = Vertex(name = 'V_132',
               particles = [ P.G0, P.G0, P.P__tilde__s0, P.P__tilde__s0 ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
               couplings = {(0,0):C.GC_53})

V_133 = Vertex(name = 'V_133',
               particles = [ P.G__minus__, P.G__plus__, P.P__tilde__s0, P.P__tilde__s0 ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
               couplings = {(0,0):C.GC_53})

V_134 = Vertex(name = 'V_134',
               particles = [ P.h, P.h, P.P__tilde__s0, P.P__tilde__s0 ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
               couplings = {(0,0):C.GC_53})

V_135 = Vertex(name = 'V_135',
               particles = [ P.P__tilde__s0, P.P__tilde__s0, P.P__tilde__s0, P.P__tilde__s0 ],
               color = [ '1' ],
               lorentz = [ L.SSSS1 ],
...
V_139 = Vertex(name = 'V_139',
               particles = [ P.h, P.P__tilde__s0, P.P__tilde__s0 ],
               color = [ '1' ],
               lorentz = [ L.SSS1 ],
...
V_142 = Vertex(name = 'V_142',
               particles = [ P.P__tilde__HE, P.e__minus__, P.P__tilde__s0 ],
               color = [ '1' ],
               lorentz = [ L.FFS1 ],
               couplings = {(0,0):C.GC_114})

V_143 = Vertex(name = 'V_143',
               particles = [ P.P__tilde__HE, P.mu__minus__, P.P__tilde__s0 ],
               color = [ '1' ],
               lorentz = [ L.FFS1 ],
               couplings = {(0,0):C.GC_115})

V_144 = Vertex(name = 'V_144',
               particles = [ P.P__tilde__HE, P.ta__minus__, P.P__tilde__s0 ],
               color = [ '1' ],
               lorentz = [ L.FFS1 ],
               couplings = {(0,0):C.GC_116})

V_145 = Vertex(name = 'V_145',
               particles = [ P.e__plus__, P.P__tilde__he, P.P__tilde__s0 ],
               color = [ '1' ],
               lorentz = [ L.FFS3 ],
               couplings = {(0,0):C.GC_114})

V_146 = Vertex(name = 'V_146',
               particles = [ P.mu__plus__, P.P__tilde__he, P.P__tilde__s0 ],
               color = [ '1' ],
               lorentz = [ L.FFS3 ],
               couplings = {(0,0):C.GC_115})

V_147 = Vertex(name = 'V_147',
               particles = [ P.ta__plus__, P.P__tilde__he, P.P__tilde__s0 ],
               color = [ '1' ],
               lorentz = [ L.FFS3 ],
               couplings = {(0,0):C.GC_116})
...
V_175 = Vertex(name = 'V_175',
               particles = [ P.P__tilde__HE, P.P__tilde__he, P.a ],
               color = [ '1' ],
               lorentz = [ L.FFV1 ],
               couplings = {(0,0):C.GC_3})

V_176 = Vertex(name = 'V_176',
               particles = [ P.P__tilde__HE, P.P__tilde__he, P.Z ],
               color = [ '1' ],
               lorentz = [ L.FFV1 ],
