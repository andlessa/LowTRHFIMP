...
GC_52 = Coupling(name = 'GC_52',
                 value = '6*complex(0,1)*lams0',
                 order = {'NP':1})

GC_53 = Coupling(name = 'GC_53',
                 value = '2*complex(0,1)*lams0h',
                 order = {'NP':1})
...
GC_91 = Coupling(name = 'GC_91',
                 value = '2*complex(0,1)*lams0h*vev',
                 order = {'NP':1,'QED':-1})
...
GC_114 = Coupling(name = 'GC_114',
                  value = '-(complex(0,1)*yHEeR)',
                  order = {'NP':1})

GC_115 = Coupling(name = 'GC_115',
                  value = '-(complex(0,1)*yHEmuR)',
                  order = {'NP':1})

GC_116 = Coupling(name = 'GC_116',
                  value = '-(complex(0,1)*yHEtaR)',
                  order = {'NP':1})
